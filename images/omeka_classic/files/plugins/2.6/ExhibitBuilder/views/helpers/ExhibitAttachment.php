...
class ExhibitBuilder_View_Helper_ExhibitAttachment extends Zend_View_Helper_Abstract
{
    ...
    public function exhibitAttachment($attachment, $fileOptions = array(), $linkProps = array(), $forceImage = false)
    {
        ...
        $linkProps['title'] = strip_tags($attachment['caption']);
        if ($file) {
            ...
            if ($forceImage) {
                ...
                $image_url = file_display_url($file);
                $html = exhibit_builder_link_to_exhibit_image($image, $image_url, $linkProps, $item);
            } else {
            ...
            $html = exhibit_builder_link_to_exhibit_image(null, $linkProps, $item);
        }
